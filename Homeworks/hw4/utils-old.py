...
class ProbDist():
	...
	def __init__(self, vlist, log=True, bin_boundaries=None):
		"""
                vlist is a list of samples. The constructor performs maximum likelihood
                on vlist to compute the	parameters of the probabilty distribution.
